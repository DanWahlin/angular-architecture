  ...
  template: `
    ...
    <section id="notes">
      ...
      <ul>
        ...
        <li>
          No longer mutates the model but rather an isolated ViewModel that
          represents the model.
        </li>
        <li>
          Adding a customer is deferred to Details and DOES NOT change the
          customer list until saved.
        </li>
        <li>
          Changes to customer details DO NOT change the customer list until
          saved.
        </li>
